           ...
           if (!_context.Trips.Any())
            {
                ...
                var usTrip = new Trip()
                {
                    ...
                    Stops = new List<Stop>()
                    {
                       new Stop() {Name = "Atlanta, GA", Arrival = new DateTime(2015, 6, 7), Latitude = 33.748995, Longitude = -84.387982, Order = 0  },
                       new Stop() {Name = "New York, NY", Arrival = new DateTime(2015, 7, 7), Latitude = 40.712783, Longitude = -74.005941, Order = 1  },
                       new Stop() {Name = "Boston, MA", Arrival = new DateTime(2015, 8, 7), Latitude = 42.360082, Longitude = -71.058880, Order = 2  },
                       new Stop() {Name = "Chicago, IL", Arrival = new DateTime(2015, 9, 7), Latitude = 41.878114, Longitude = -87.629798, Order = 3  },
                       new Stop() {Name = "Seattle, WA", Arrival = new DateTime(2015, 10, 7), Latitude = 47.606209, Longitude = -122.332071, Order = 4  },
                       new Stop() {Name = "Atlanta, GA", Arrival = new DateTime(2015, 11, 7), Latitude = 33.748995, Longitude = -84.387982, Order = 5  },
                    }
                };
